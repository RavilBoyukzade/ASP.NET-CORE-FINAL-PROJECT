...
namespace Repository.Migrations
{
    ...
    [Migration("20200529050740_AddCaseStudCollapseModel")]
    partial class AddCaseStudCollapseModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Models.BestPlanCateg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("BestPlanId");

                    b.ToTable("BestPlanCategs");
                });
            ...
            modelBuilder.Entity("Repository.Models.CaseStud", b =>
                {
                    ...
                    b.Property<string>("InsuranceProfile")
                        .IsRequired()
                        .HasColumnType("nvarchar(50)")
                        .HasMaxLength(50);
            ...
            modelBuilder.Entity("Repository.Models.CaseStudCollapse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("CaseStudId");

                    b.ToTable("CaseStudCollapses");
                });
            ...
            modelBuilder.Entity("Repository.Models.BestPlanCateg", b =>
                {
                    b.HasOne("Repository.Models.BestPlan", "BestPlan")
                        .WithMany("PlanCategs")
                        .HasForeignKey("BestPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Repository.Models.CaseStudCollapse", b =>
                {
                    b.HasOne("Repository.Models.CaseStud", "CaseStud")
                        .WithMany("CaseStudCollapses")
                        .HasForeignKey("CaseStudId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
